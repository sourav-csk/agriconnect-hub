    ...
    <div className="pb-24 px-4 pt-6 max-w-lg mx-auto">
      ...
      <div className="bg-primary text-primary-foreground rounded-2xl p-5 mb-6 shadow-md">
        ...
        <div className="flex items-center gap-4 text-sm">
          <span className="flex items-center gap-1">
            <Droplets className="w-4 h-4" /> {weatherData.humidity}% Humidity
          </span>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button
          ...
          className="bg-secondary text-secondary-foreground rounded-2xl p-4 flex flex-col items-center gap-2 shadow-sm active:scale-95 transition-transform"
        >
          <span className="text-3xl">📦</span>
          <span className="font-bold">Sell Crop</span>
        </button>
        <button
          onClick={() => navigate("/marketplace")}
          className="bg-card border border-border rounded-2xl p-4 flex flex-col items-center gap-2 shadow-sm active:scale-95 transition-transform"
        >
          <span className="text-3xl">🏪</span>
        ...
        >
          <span className="text-3xl">🤖</span>
          <span className="font-bold">AI Advice</span>
        </button>
        <button
